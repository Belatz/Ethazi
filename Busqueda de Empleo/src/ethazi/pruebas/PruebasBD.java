	...
	public static void insertar() {
		try {
			...
			if (!rs.next()) {
				...
				// Datos Candidato
				Conexion.actualizar(
						"INSERT INTO candidato VALUES ('Perez Lopez',20/04/2000,1,1,0,'Contable','Informática','He trabajado 7 años como responsable de finanzas en una multinacional',10.3,'11111111D')");
				Conexion.actualizar(
						"INSERT INTO candidato VALUES ('Garcia Lopez',31/01/1990,0,0,1,'Programador','Inglés','Llevo un año en un proyecto de gestion de datos',5.6,'22222222L')");
				Conexion.actualizar(
						"INSERT INTO candidato VALUES ('Garcia Garcia',01/02/2002,1,1,1,'Limpiadora','Euskera y Ingles',' ',1.9,'33333333K')");
				Conexion.actualizar(
						"INSERT INTO candidato VALUES ('Sanchez Iglesias',05/05/1995,0,0,0,'Director RRHH','Curso RCP','LLevo 20 años como encargado de recursos humanos de una multinacional muy importante',2.2,'44444444A')");
				Conexion.actualizar(
						"INSERT INTO candidato VALUES ('López Vázquez',10/09/19960,1,0,1,'Secretaria','Mecanografía','Secretaria con buen perfil se anuncia para trabajar en su empresa',25.8,'55555555P')");
				...
				// Datos solicitudes
				ResultSet primeraOferta = Conexion.consultar("SELECT MIN("+Tablas.C_OFERTA_CODIGO+") FROM "+Tablas.C_OFERTA_TABLA+";");
				primeraOferta.next();
				int codigo = primeraOferta.getInt("MIN("+Tablas.C_OFERTA_CODIGO+")");
				
				Conexion.actualizar(
						"INSERT INTO solicitudes VALUES ("+codigo+",'11111111D','Buenos dias: Estaria encantado de colaborar con vosotros')");
				Conexion.actualizar(
						"INSERT INTO solicitudes VALUES ("+(codigo+1)+",'11111111D','Buenos tardes: Estoy con muy poco dinero y tengo una gran urgencia de trabajar')");
				Conexion.actualizar(
						"INSERT INTO solicitudes VALUES ("+(codigo+2)+",'22222222L','Tengo gran interes en trabajar con ustedes')");
				Conexion.actualizar(
						"INSERT INTO solicitudes VALUES ("+(codigo+3)+",'33333333K','Buenos dias: Tengo gran interes en los proyectos que estan haciendo actualmente')");
				Conexion.actualizar(
						"INSERT INTO solicitudes VALUES ("+(codigo+4)+",'11111111D','Estoy muy interesado en su oferta')");
				Conexion.actualizar(
						"INSERT INTO solicitudes VALUES ("+(codigo+5)+",'11111111D','Buenos dias: Estaria encantado de colaborar con vosotros')");
				Conexion.actualizar(
						"INSERT INTO solicitudes VALUES ("+(codigo+6)+",'11111111D','Buenos dias: Estoy muy interesado en su oferta')");
				Conexion.actualizar(
						"INSERT INTO solicitudes VALUES ("+(codigo+7)+",'55555555P','Buenos tardes: Mi situacion economica no es muy buena y necesito trabajar')");
				Conexion.actualizar(
						"INSERT INTO solicitudes VALUES ("+(codigo+8)+",'55555555P','Buenos tardes: Mi situacion economica no es muy buena y necesito trabajar')");
			}
